...
import numpy as np
from phantom_generator import DigitalPhantomGenerator
...
if __name__ == "__main__":
    # 1. Configure and create the phantom generator
    # Use CUDA if available for the PDE simulation, otherwise CPU
    ...
    # 2. Generate the phantom data
    phantom_data = generator.generate()
