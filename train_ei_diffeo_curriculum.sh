...
#SBATCH --error=logs/ei_diffeo_no_encoding_curriculum.err
#SBATCH --output=logs/ei_diffeo_no_encoding_curriculum.out
#SBATCH --exclude=''
#SBATCH --gpus-per-node=1
#SBATCH --job-name=ei_diffeo_no_encoding_curriculum
