...
#SBATCH --error=logs/ei_rotate_50degrees_no_encoding.err
#SBATCH --output=logs/ei_rotate_50degrees_no_encoding.out
#SBATCH --exclude=''
#SBATCH --gpus-per-node=1
#SBATCH --job-name=ei_rotate_50degrees_no_encoding
