...
#SBATCH --error=logs/no_encoding_real_svd_no_lowk_dc.err
#SBATCH --output=logs/no_encoding_real_svd_no_lowk_dc.out
#SBATCH --exclude=''
#SBATCH --gpus-per-node=1
#SBATCH --job-name=no_encoding_real_svd_no_lowk_dc
