...
BASE_PATH="/ess/scratch/scratch1/rachelgordon/fastMRI_breast_data/full_kspace/fastMRI_breast_"
...
for ((i = 1; i <= 300; i += 1)); do
    ...
    bash loop_single_data_nifti.sh "$DATA_PATH" /ess/scratch/scratch1/rachelgordon/non_zf_data_83_slices 2 True 288 0 83 100 True
done