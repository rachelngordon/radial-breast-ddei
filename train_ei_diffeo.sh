...
#SBATCH --error=logs/lsfp_ei_diffeo_aug_enc_random_slice_val2spf.err
#SBATCH --output=logs/lsfp_ei_diffeo_aug_enc_random_slice_val2spf.out
#SBATCH --exclude=''
#SBATCH --gpus-per-node=1
#SBATCH --job-name=lsfp_ei_diffeo_aug_enc_random_slice_val2spf
