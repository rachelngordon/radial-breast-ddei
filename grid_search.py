...
def main():
    ...
    # Keys should be the dot-separated path to the parameter in the YAML file

    param_grid = {
        'model.optimizer.lr': [1e-2, 1e-3, 1e-4],
        'model.num_layers': [1, 2, 3],
    }

    # param_grid = {
    #     'model.lambda_L': [0.00025, 0.0025, 0.025, 0.05, 0.1],
    ...
    # param_grid = {
    #     'model.gamma': [0.05, 0.1, 0.5, 0.75],
    #     'model.lambda_step': [0.001, 0.01, 0.1, 0.5],
    # }
    
    # Base configuration file
    base_config_file = 'configs/config_mc_lsfp.yaml' # <-- Make sure this is your base config
...
if __name__ == '__main__':
    # Make sure you change this to the actual name of your training script!
    # e.g., "train.py"
    main()