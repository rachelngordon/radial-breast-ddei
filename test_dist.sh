...
#SBATCH --error=logs/test_dist.err
#SBATCH --output=logs/test_dist.out
#SBATCH --exclude=''
...
torchrun --nproc_per_node=1 new_train.py --config configs/config_mc_dist.yaml --exp_name test_dist