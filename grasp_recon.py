...
IN_DIR = '/ess/scratch/scratch1/rachelgordon/fastMRI_breast_data/full_kspace/fastMRI_breast_001_2.h5'
spokes_per_frame = 8
center_partition = 31
images_per_slab = 192
...
plt.imshow(np.abs(acq_slices[0]))
plt.savefig('/gpfs/data/karczmar-lab/workspaces/rachelgordon/breastMRI-recon/ddei/example_grasp_recon.png')